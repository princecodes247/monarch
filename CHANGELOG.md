...
- a75bde6: Add MonarchPhantom type for types that are not persisted to db (eg. ref)
...
- a75bde6: Refactor types to store scope information, this allows the restriction of certian types in certain locations (eg. relation types)
